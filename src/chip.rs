            ...
            if self.wait_for_key.is_none() {
                ...
                match opcode & 0xf000 {
                    ...
                    0x8000 => match opcode & 0x000f {
                        0x0000 => self.ld_vv(x, y),
                        0x0001 => self.or(x, y),
                        0x0002 => self.and(x, y),
                        0x0003 => self.xor(x, y),
                        0x0004 => self.add_vv(x, y),
                        0x0005 => self.sub(x, y),
                        0x0006 => self.shr(x),
                    ...
                    0xf000 => match opcode & 0x00ff {
                        0x0007 => self.ld_vdt(x),
                        0x000a => self.ld_k(x),
                        0x0015 => self.ld_dtv(x),
                        0x0018 => self.ld_stv(x),
                        0x001e => self.add_i(x),
                        0x0029 => self.ld_f(x),
                        0x0033 => self.ld_b(x),
                        0x0055 => self.ld_vstomem(x),
                        0x0065 => self.ld_vsfrommem(x),
                        unknown => panic!("Unknown instruction with opcode {:x}", unknown),
                    },
                    unknown => panic!("Unknown instruction with opcode {:x}", unknown),
                }
